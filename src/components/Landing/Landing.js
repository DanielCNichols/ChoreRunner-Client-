      ...
      <div className="landing">
        ...
        <div className="landing-grid">
          ...
          <div className="kids">
            ...
            <p>
              Can you collect all 10 badges and become the top chorerunner in
              your house? Ask your parents to help you sign up today!
            </p>
          ...
          {/* parents */}
          <h3 className="about-header">For parents!</h3>
          ...
          <div className="parents">
              ...
              <p>
                "Who's turn is it to do the dishes? Didn't you ask them to
                finish this two days ago?""
              </p>
              <p>
